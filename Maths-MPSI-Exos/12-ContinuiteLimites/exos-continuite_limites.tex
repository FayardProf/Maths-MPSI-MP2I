...
\magsubsection{Propriété locale}
...
\magsubsection{Limite et ordre sur $\R$}
\magsubsection{Limite à gauche, limite à droite}
...
\magsubsection{Continuité ponctuelle}
...
% \begin{questions}
% \question Montrer que
%   \[\mathcal{D}\defeq\ensim{\frac{p}{2^n}}{p\in\Z \et n\in\N}\]
%   est dense dans $\R$.
...
\magsubsection{Continuité sur une partie}
\magsubsection{Théorème des valeurs intermédiaires}
...
\exercice{nom={Preuve du théorème des valeurs intermédiaires}}
...
\exercice{nom={Monotonie des injections continues sur un intervalle}}
...
\magsubsection{Théorème de compacité}
...
\magsubsection{Continuité uniforme}
