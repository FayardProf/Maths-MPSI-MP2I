...
\magsubsection{Conjugaison sur $\fracC$}



\magsection{Décomposition en éléments simples}
\magsubsection{Décomposition en éléments simples sur $\fracK$}
\magsubsection{Cas où le dénominateur est scindé}
...
\magsubsection{Cas où $\K=\R$ et le dénominateur n'est pas scindé}
...
\magsubsection{Fractions rationnelles}
...
\magsubsection{Fractions rationnelles en $\e^x$}
\magsubsection{Fractions rationnelles en $\cos x$, $\sin x$}
...
\magsubsection{Fractions rationnelles en $\ch x$, $\sh x$}
\magsubsection{Fractions rationnelles en $x$ et $\sqrt[n]{(ax+b)/(cx+d)}$, en $x$ et $\sqrt{ax^2+bx+c}$}
