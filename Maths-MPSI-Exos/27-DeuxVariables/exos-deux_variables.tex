...
\magsubsection{Notion d'ouvert}
\magsubsection{Limite}
...
\magsubsection{Application partielle}
\magsubsection{Extension aux fonctions à valeurs dans $\R^2$}
...
\magsubsection{Dérivée partielle}
...
\magsubsection{Développement limité, gradient}
...
% \end{questions}
% \end{solution}
\magsubsection{Dérivation des fonctions composées}
...
\magsubsection{Extrémum d'une fonction de deux variables}
