...
% \begin{remarqueUnique}
% \remarque En particulier, si $x$ est symétrisable
%   \[\forall n\in\Z\qsep x^n\star x^{-n}=x^{-n}\star x^n=e.\]
% \end{remarqueUnique}
...
% \begin{proposition}
% Soit $\sigma=\p{x_1 \quad x_2 \quad \cdots \quad x_p}$ un cycle de longueur $p$.
% Alors~:
% \[\sigma=\p{x_1 \quad x_2}\p{x_2 \quad x_3}\cdots\p{x_{p-1} \quad x_p}\]
% \end{proposition}
...
%   permutations de supports deux à deux disjoints telle que
