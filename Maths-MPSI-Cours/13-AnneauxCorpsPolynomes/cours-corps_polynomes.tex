...
%   que $P=a_0+a_1X+\cdots+a_n X^n$ et . Alors,
%   en prolongeant la définition des $a_k$ et $b_k$ comme dans la remarque précédente, on a
%   La suite $(a_k)_{k\in\N}$ est nulle à partir d'un certain rang et est appelée suite des 
