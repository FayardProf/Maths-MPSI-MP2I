...
\section{Exercices}
\setcounter{numeroexercice}{1}
\input{exos-representation_donnees}
...
\input{tp-introduction_logo}

\chapter{Altimètre, Syracuse}
\input{tp-altimetre_syracuse}

\chapter{Cryptage de César}
\input{tp-cryptage_cesar}

% \chapter{Levenshtein, Hamming}
% \input{tp-levenshtein_hamming}

\chapter{Sudoku}
\input{tp-sudoku}

\chapter{Récursif, ligne d'horizon}
\input{tp-recursif_horizon}

\chapter{Coupe de somme minimale}
\input{tp-coupe_somme_minimale}
